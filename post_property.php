...
<section class="property-form">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="box">
            ...
            <input type="text" name="property_name" maxlength="50" required placeholder="enter your name" class="input">
        </div>
        
        <div class="flex">
            <div class="box">
                <p>property price<span>*</span></p>
                <input type="number" name="price" maxlength="10" min="0" max="9999999999"  required placeholder="enter your price" class="input">
            </div>
