<footer class="footer">
    ...
    <section class="flex">
        ...
        <div class="box">
            ...
            <a href="tel:1112223333"><i class="fas fa-phone"></i><span>+111-222-3333</span></a>
    ...
    <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>Web designer</span> | all rights reserved! </div>
